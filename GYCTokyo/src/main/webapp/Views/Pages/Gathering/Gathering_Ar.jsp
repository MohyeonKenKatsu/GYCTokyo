...
<%
	...
	String  sJobStatus	= null;								// 파라미터 : 작업상태 - 데이터베이스 작업상태(SELECT | INSERT | DELETE)
	String  sGROUP_ID	= null;								// 파라미터 : 그룹아이디

	// ---------------------------------------------------------------------
	// [JSP 지역 변수 선언 : 데이터베이스 파라미터]
	// ---------------------------------------------------------------------
	ArrayList<GatheringDTO> Gathering = null;				// 모임 만들기 ArrayList 객체 
	// ---------------------------------------------------------------------
	// [JSP 지역 변수 선언 : 일반 변수]
	// ---------------------------------------------------------------------
	Boolean bContinue		= false;						// 모임 정보 검색 유무
	// ---------------------------------------------------------------------
